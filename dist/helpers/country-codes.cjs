...
__export(country_codes_exports, {
  ...
  getAllCountriesSorted: () => getAllCountriesSorted,
  getAllCountryCodes: () => getAllCountryCodes,
  getCountryByCode: () => getCountryByCode,
  getCountryByISO: () => getCountryByISO,
  getTotalCountries: () => getTotalCountries,
  validatePhoneByCountry: () => validatePhoneByCountry
});
...
var getAllCountriesSorted = () => {
  return [...countryPhoneData].sort((a, b) => a.country.localeCompare(b.country));
};
var validatePhoneByCountry = (phoneNumber, iso) => {
